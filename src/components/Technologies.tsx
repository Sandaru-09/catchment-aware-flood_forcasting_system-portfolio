...
const Technologies = () => {
  const technologies = [
    ...
    { name: "Kafka", category: "Data Streaming", description: "Real-time data streaming and message processing" },
  ...
  const categories = ["Backend", "Frontend", "Machine Learning", "Database", "Cloud", "Mapping", "DevOps", "Data Streaming", "Security"];
