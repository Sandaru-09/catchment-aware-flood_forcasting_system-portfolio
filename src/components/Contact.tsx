    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#54416d] mb-4">Get in Touch</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg p-8 shadow-lg">
            <h3 className="text-2xl font-semibold text-[#54416d] mb-6">Send us a Message</h3>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#75b4e3] focus:border-transparent"
              ...
              <button
                type="submit"
                className="w-full bg-[#75b4e3] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#54416d] transition-colors"
              >
                Submit
              </button>
            </form>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg p-8 shadow-lg">
              <h3 className="text-2xl font-semibold text-[#54416d] mb-6">Contact Details</h3>
              
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="bg-[#75b4e3] text-white rounded-full w-12 h-12 flex items-center justify-center">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#54416d] mb-1">Response Time</h4>
            ...
            <div className="bg-gradient-to-r from-[#75b4e3] to-[#54416d] rounded-lg p-8 text-white">
              <h3 className="text-xl font-semibold mb-4">Follow Our Research</h3>
              <p className="text-blue-100 mb-6">
                Stay updated with our latest research findings, publications, and project developments.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="bg-white/20 hover:bg-white/30 rounded-lg p-3 transition-colors">
